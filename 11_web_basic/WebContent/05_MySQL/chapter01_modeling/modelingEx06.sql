...
INSERT INTO TEST3(PRODUCT_CD , PRODUCT_NM) VALUES(1 , '상품6'); 			  # ERROR(PRODUCT_CD > UNIQUE제약 위반)
INSERT INTO TEST3(PRODUCT_CD , PRODUCT_NM) VALUES(7 , '상품1');				  #  ERROR(PRODUCT_NM > UNIQUE제약 위반)
SELECT * FROM TEST3;
...
INSERT INTO TEST5(PRODUCT_CD , PRODUCT_NM) VALUES(3 , '상품3');		 # SUCCESS(초깃값 적용)
...
INSERT INTO TEST7(PRODUCT_NM , PRICE , REG_DT) VALUES('상품2', 2000 , NOW()); # ERROR (PRODUCT_CD > NOT NULL제약 위반)
INSERT INTO TEST7(PRODUCT_CD , PRICE , REG_DT) VALUES(3, 3000 , NOW());       # SUCCESS
INSERT INTO TEST7(PRICE , REG_DT) VALUES(4000 , NOW());      				  # ERROR (PRODUCT_CD > NOT NULL제약 위반)
INSERT INTO TEST7(REG_DT) VALUES(NOW()); 									  # ERROR (PRODUCT_CD > NOT NULL제약 위반)
INSERT INTO TEST7(PRODUCT_CD , PRODUCT_NM) VALUES(6 , '상품6'); 			  # SUCCESS
INSERT INTO TEST7(PRODUCT_CD , PRODUCT_NM) VALUES(6 , '상품7'); 			  # ERROR (PRODUCT_CD > UNIQUE제약 위반)
SELECT * FROM TEST7;


# 8~10) PRIMARY KEY , FOREIGN KEY
